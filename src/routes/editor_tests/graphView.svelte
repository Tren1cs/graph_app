...
<div class=" overflow-hidden bg-transparent h-full w-full text-white top-0 left-0 text-center content-center z-10 absolute m-0">
    <div style="transform: scale({scale}); transform-origin: {origin.x}px {origin.y}px">
